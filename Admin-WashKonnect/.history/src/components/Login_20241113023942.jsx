...
<div className=' bg-blue-400'>
  <div className=''> <h1 className='block  font-bold text-3xl mb-[-2rem] text-white'>WashKonnect</h1></div>

<div className="flex items-center justify-center min-h-screen ">
      
      
      <div className="w-full max-w-md px-8 pb-8 space-y-6 bg-white rounded-lg shadow-lg">
