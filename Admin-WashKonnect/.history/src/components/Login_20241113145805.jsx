...
const Login = () => {
  ...
  return (
    ...
    <> 
<div className=' bg-blue-400 my-0'>
  <div className='flex mx-auto my-auto  justify-center items-center'> <img src={WashkonnectLogo} className='object-cover w-[20rem] mb-[-17rem]' alt="" /></div>
