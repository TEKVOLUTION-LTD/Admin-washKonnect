...
const Login = () => {
  ...
  return (
    ...
    <> 
<div className='block mx-auto bg-blue-400 m-9 '>
  <div className='justify-center items-center'> <img src={WashkonnectLogo} className='object-cover w-[10rem] mb-[-12rem]' alt="" /></div>
